 ...
 * gradient — the eye finishes on "GitOrbit doesn't."
 */
function Headline() {
  const lines: { words: string[]; className: string }[] = [
    { words: ["GitHub", "forgets."], className: "text-gradient" },
    { words: ["GitOrbit", "doesn't."], className: "text-gradient-brand" },
  ];
      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 lg:grid-cols-[1.05fr_1fr] lg:gap-16 lg:px-8">
        ...
        <div>
          ...
          >
            ...
            <span className="text-ink-2">14 days</span> of repository traffic; GitOrbit
          ...
          >
            ...
            <Button asChild variant="secondary" size="lg">
              <a
                  href="https://github.com/mahigautam14"
                  target="_blank"
