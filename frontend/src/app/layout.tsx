...
export const metadata: Metadata = {
  ...
  description:
    "See who followed you, who left, and when — on one dashboard. GitHub keeps only 14 days of repository traffic; GitOrbit records views and clones every day and builds the full history it never gave you.",
  openGraph: {
    title: "GitOrbit — GitHub forgets. GitOrbit doesn't.",
    description:
